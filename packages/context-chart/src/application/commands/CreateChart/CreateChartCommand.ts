...
import { Note, Section, Structure, TenantID } from '@chordcraft/shared/valueObjects';

export class CreateChartCommand extends Schema.Class<CreateChartCommand>('CreateChartCommand')({
  root: Note.transform,
  ...
  links: Schema.Array(Schema.String.pipe(Schema.maxLength(255))).pipe(Schema.maxItems(12)),
