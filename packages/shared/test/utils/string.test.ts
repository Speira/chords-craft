...
describe('StringUtils test suite', () => {
  ...
  describe('removeHtml', () => {
    it('Should remove HTML tags', () => {
      ...
      expect(StringUtils.removeHtml('<p>Test <strong>bold</strong></p>')).toBe('Test bold');
    });
  ...
  describe('unescapeHtml', () => {
    it('Should unescape HTML entities', () => {
      expect(StringUtils.unescapeHtml('&lt;div&gt;Hello&lt;/div&gt;')).toBe('<div>Hello</div>');
    ...
    it('Should unescape multiple entities', () => {
      expect(
        StringUtils.unescapeHtml('&lt;div class=&quot;test&quot;&gt;A &amp; B&lt;/div&gt;'),
  ...
  describe('formatSentence', () => {
    ...
    it('Should capitalize first letter after punctuation', () => {
      ...
      expect(StringUtils.formatSentence('great! awesome. nice?')).toBe('Great! Awesome. Nice?');
    });
