 ...
 * - CheckPassword: Validates if a password meets security requirements (uppercase, lowercase, digit,
...
export class StringUtils {
  ...
  /**
   * Formats a sentence to display correctly (capitalize the first letter and uppercase the first
