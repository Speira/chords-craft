    ...
    <header className="grid grid-cols-3 p-4 text-secondary-foreground 2xl:px-10">
      <div className="flex items-center gap-1.5">
        <div className="relative h-12 w-12">
          <Image src="/chart-logo.webp" alt="Logo" priority fill className="object-contain" />
        </div>
        <Typography isServer as="strong" className="text-md text-primary" label="general.title" />
        {startNode}
      </div>
      <HeaderNavigation />
